package com.zjzmjr.finance.web.audit.form;
...
public class AuditForm extends BaseForm{
   ...
   /**  */
    ...
    /**
     * step 315审核合同是否需要总工审核1：需要 2：不需要
     */
    ...
    public String toString() {
        return "AuditForm [id=" + id + ", companyId=" + companyId + ", name=" + name + ", adminName=" + adminName + ", projectId=" + projectId + ", applicant=" + applicant + ", type=" + type + ", status=" + status + ", projectNo=" + projectNo + ", createTimeStart=" + createTimeStart + ", createTimeEnd=" + createTimeEnd + ", verifyTimeStart=" + verifyTimeStart + ", verifyTimeEnd=" + verifyTimeEnd + ", step=" + step + ", subStep=" + subStep + ", subStep2=" + subStep2 + ", memo=" + memo
                + ", amount=" + amount + ", paymentMode=" + paymentMode + ", haveTechnical=" + haveTechnical + ", haveScheme=" + haveScheme + ", haveDevelopment=" + haveDevelopment + ", haveDrawing=" + haveDrawing + ", havePlanning=" + havePlanning + ", isMajorProject=" + isMajorProject + ", ischief=" + ischief + ", officeType=" + officeType + ", manageType=" + manageType + ", leaderType=" + leaderType + ", lawType=" + lawType + ", chiefType=" + chiefType + ", financialType=" + financialType
                + "]";
    }
