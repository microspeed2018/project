...
public class SharedFileForm extends BaseForm {
    ...
    private MultipartFile[] saveAddress;
    ...
    public MultipartFile[] getSaveAddress() {
        return saveAddress;
    }
    
    public void setSaveAddress(MultipartFile[] saveAddress) {
        this.saveAddress = saveAddress;
    }

    @Override
    public String toString() {
        return "SharedFileForm [id=" + id + ", companyId=" + companyId + ", sharedStaff=" + sharedStaff + ", fileName=" + fileName + ", fileExplain=" + fileExplain + ", saveName=" + saveName + ", sourceType=" + sourceType + ", isMessage=" + isMessage + ", isSms=" + isSms + ", isTop=" + isTop + ", userId=" + userId + ", name=" + name + ", startDate=" + startDate + ", endDate=" + endDate + ", version=" + version + ", saveAddress=" + Arrays.toString(saveAddress) + "]";
    }
