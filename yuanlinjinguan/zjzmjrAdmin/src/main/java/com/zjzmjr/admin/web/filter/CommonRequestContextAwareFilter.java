 ...
 */
package com.zjzmjr.admin.web.filter;
 ...
 *
 * @author elliott
 * @version $Id: CommonRequestContextAwareFilter.java, v 0.1 2014-1-14 下午3:14:11 elliott Exp $
 */
public class CommonRequestContextAwareFilter implements Filter {
    ...
    public void doFilter(ServletRequest req, ServletResponse resp, FilterChain chain)
        ...
        req.setAttribute("img_url", imgUrl);
