 ...
 * 
 * @author lenovo
 * @version $Id: GetQrCodeController.java, v 0.1 2017-12-29 上午10:04:46 lenovo Exp $
 */
@Controller
...
public class GetQrCodeController extends BaseController{
    ...
    public void getQrCode(HttpServletResponse resp, HttpServletRequest req){
        ...
        String address = "http://service.project.cbylsj.com/tpl/resume/index.html?recruitmentId="+id+"&companyId="+SpringSecurityUtil.getIntCompany();
        try { 
