...
<head>
    ...
    <script type="text/javascript" src="${res_js }/jslib/insuranceArea.js?v=${ver}"></script>
<script type="text/javascript">
	$(function(){
		$("#datagrid").datagrid({
            url: "/insuranceArea/user/getInsuranceArea.htm",
            title: '保险地区列表',
            showFooter: true,
            pagePosition: 'bottom',
            pagination: true,
	...
	function getOptByStatus(row, index){
		var opts = "";
		opts+="<a href='javascript:commitProduct("+row.id+")'>清除</a> ";
		return opts;
	}
            ...
            <form id="form" class="inner-q" onsubmit="return false;">
                <table cellpadding="0" cellspacing="0">
                    <tr>
                        <th>地区编号</th>
                        <td>
                        <input type="text" id="areaId"name="areaId" class="input">
                        </td>
                        <th>地区名称</th>
                        <td>
