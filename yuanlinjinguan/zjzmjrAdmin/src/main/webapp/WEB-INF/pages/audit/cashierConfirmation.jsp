...
<body>
    ...
    <script type="text/javascript">
        ...
        $(function() {
            $("#datagrid").datagrid(
                {
                    url : '${ctx}/cashierConfirmation/user/getProjectCashierConfirmation.htm',
                    title:'出纳确认',
                        ...
                        },
                        {
                            ...
                            formatter: function (value, row, index) {
                                if (!row.status) {
                                    if(row.type==30){
                                       //
                                       return "<a href='javascript:result("+ index +")'>确认</a>|<a href='javascript:checkbail("+ row.projectId +","+row.companyId+")'>查看</a>";
                                    }else{
                                       return "<a href='javascript:result("+ index +")'>确认</a>";
                                    } 
        ...
        function result(index) {
            ...
            var id = list.id;
            $.ajax({
                url: "/cashierConfirmation/user/updateCashierConfirmationById.htm",
                type: 'post',
                dataType: 'json',
                data: {
                    status : 1,
