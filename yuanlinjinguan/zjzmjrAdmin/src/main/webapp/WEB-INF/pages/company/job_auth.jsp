...
<body>
    ...
    <script type="text/javascript">
        ...
        $(function() {
            $("#datagrid").datagrid(
                {
                    url : '${ctx}/job/user/getjobDepartment.htm',
                    title:'职位信息',
                    ...
                    columns:[[
                        ...
                        },
                        {
                            ...
                            width: 80,
                            formatter: function (value, row, index) {
                                var dom = "<a href='javascript:showDetail(" + index + ")'>修改</a><span style='padding: 0 5px;'>|</span>";
                                if (row.status) {
                                    dom += "<a href='javascript:setVal(" + index + ")'>无效</a>";
                                } else {
                                    dom += "<a href='javascript:setVal(" + index + ")'>有效</a>";
                                }
                                dom +="<span style='padding: 0 5px;'>|</span><a href='javascript:showBindAuth(\"JobGroupAuth\", "+row.id+")'>权限</a>";
                                return dom;
                            }
                        }
                    ]],
